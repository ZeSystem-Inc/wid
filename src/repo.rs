...
/// sources.list dosyasının tam yolunu döndürür.
/// Örnek: C:\Users\Kullanici\AppData\Roaming\wid\sources.list
...
pub fn update_sources_from_internet() -> Result<usize, String> {
    ...
    println!("✨ Havuz güncellendi ({} paket)", count);
    Ok(count)
}
