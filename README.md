...
Please use the latest stable version: **v2.1.0**.
...
- Auto architecture detection (64/32-bit).
...
**The only supported method:** Download `wid_installer_v2.1.0.exe` from GitHub Releases and run it.
...
- Releases: https://github.com/ZeSystem-Inc/wid/releases